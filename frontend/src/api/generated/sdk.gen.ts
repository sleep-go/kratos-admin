...
export const fileServiceAddReference = <ThrowOnError extends boolean = false>(options: Options<FileServiceAddReferenceData, ThrowOnError>): RequestResult<FileServiceAddReferenceResponses, FileServiceAddReferenceErrors, ThrowOnError> => (options.client ?? client).post<FileServiceAddReferenceResponses, FileServiceAddReferenceErrors, ThrowOnError>({
...
export const fileServiceRemoveReference = <ThrowOnError extends boolean = false>(options: Options<FileServiceRemoveReferenceData, ThrowOnError>): RequestResult<FileServiceRemoveReferenceResponses, FileServiceRemoveReferenceErrors, ThrowOnError> => (options.client ?? client).delete<FileServiceRemoveReferenceResponses, FileServiceRemoveReferenceErrors, ThrowOnError>({ url: '/api/v1/files/{fileId}/references/{businessType}/{businessId}', ...options });
