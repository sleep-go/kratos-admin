...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.TenantID = field.NewUint64(tableName, "tenant_id")
	_role.Code = field.NewString(tableName, "code")
	_role.Name = field.NewString(tableName, "name")
	_role.DataScope = field.NewUint8(tableName, "data_scope")
	_role.IsBuiltin = field.NewBool(tableName, "is_builtin")
...
func (r *role) updateTableName(table string) *role {
	...
	r.DataScope = field.NewUint8(table, "data_scope")
	r.IsBuiltin = field.NewBool(table, "is_builtin")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["is_builtin"] = r.IsBuiltin
